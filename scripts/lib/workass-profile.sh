...
workass_load_profile() {
  ...
  WORKASS_AGENT_CONTROL_FILE="$WORKASS_STATE_DIR/agent-control.json"
  WORKASS_DAEMON_URL="http://127.0.0.1:$WORKASS_DAEMON_PORT"
  ...
  export WORKASS_RUN_DIR WORKASS_BROWSER_CONTROL_FILE WORKASS_AGENT_CONTROL_FILE
