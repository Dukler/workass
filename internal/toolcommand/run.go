...
// Run executes one direct Workass CLI command. It performs exactly one
// authenticated request; uncertain mutations must be read back by the caller
// with the same operation id rather than retried here.
