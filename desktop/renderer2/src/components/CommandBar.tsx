...
export function CommandBar() {
  ...
  const commands = useMemo<Command[]>(() => [
    ...
    {
      id: 'machines',
      title: 'Conectar Workass',
		detail: 'Elegí una Workass descubierta en tu red y solicitá la conexión.',
      keywords: 'machines maquina remoto remote builder conectar emparejar descubrir red',
      run: () => { store.closeCommandBar(); store.openSettings('maquinas'); },
    },
    {
      id: 'devices',
      title: 'Acceso aprobado',
      detail: 'Qué clientes conservan acceso a esta Workass, y revocarlos.',
